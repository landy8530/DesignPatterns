...
public class RequestDetail {
    ...
    private String frequencyToDebit;
    private String carrierEffectiveDate;
    ...
    public String getCarrierEffectiveDate() {
        return carrierEffectiveDate;
    }

    public void setCarrierEffectiveDate(String carrierEffectiveDate) {
        this.carrierEffectiveDate = carrierEffectiveDate;
    }
    ...
    public String getFrequencyToDebit() {
        return frequencyToDebit;
    }
