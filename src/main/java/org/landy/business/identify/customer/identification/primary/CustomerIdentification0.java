 ...
 */
@IdentifyPriority(priority = PrimaryKeyCombination.PRIORITY_ONE,workflowId = WorkflowEnum.CUSTOMER)
@KeyIdentificationStrategy(workflowId = WorkflowEnum.CUSTOMER,beanName = CustomerIdentification0.BEAN_NAME)
@Component
