 ...
 */
@IdentifyPriority(priority = PrimaryKeyCombination.PRIORITY_TWO,workflowId = WorkflowEnum.CUSTOMER)
@KeyIdentificationStrategy(workflowId = WorkflowEnum.CUSTOMER,beanName = CustomerIdentification2.BEAN_NAME)
@Component
