 ...
 */
@IdentifyPriority(priority = PrimaryKeyCombination.PRIORITY_ONE,workflowId = WorkflowEnum.ORDER)
@KeyIdentificationStrategy(workflowId = WorkflowEnum.ORDER,beanName = OrderIdentification0.BEAN_NAME)
@Component
